...
class ServiceSearch extends Service
{
    ...
    {
        return [
            [['id', 'category_id', 'created_at', 'updated_at', 'promo'], 'integer'],
            [['sku', 'title_en', 'title_pt', 'summary_en', 'summary_pt', 'description_en', 'description_pt', 'availability_en', 'availability_pt', 'catName', 'promo_txt_en', 'promo_txt_pt'], 'safe'],
            [['price'], 'number'],
        ];
    }
