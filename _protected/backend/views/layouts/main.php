    ...
    <div class="wrap">
        <?php
            ...
            if (Yii::$app->user->can('admin'))
            {
                ...
                $menuItems[] = ['label' => Yii::t('app', 'Team'), 'url' => ['/team/index']];
                $menuItems[] = ['label' => Yii::t('app', 'About'), 'url' => ['/about/view', 'id' => 1]];
                $menuItems[] = ['label' => Yii::t('app', 'Contacts'), 'url' => ['/contact/view', 'id' => 1]];
